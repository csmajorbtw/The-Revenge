...
FOR %%A In (C:\Users\%USERNAME%\Desktop\TheRevenge\GAMEINFO\Button\batbox.exe) DO (IF Not Exist "%%A" (Echo. Box Function, Error... File [%%A] is Missing...))
Set _Ver=4.0
...
IF /i "%~9" == "" (C:\Users\%USERNAME%\Desktop\TheRevenge\GAMEINFO\Button\batbox.exe %color% %_final% /c 0x07) ELSE (ENDLOCAL && Set "%~9=%color% %_final% /c 0x07")
goto :eof
